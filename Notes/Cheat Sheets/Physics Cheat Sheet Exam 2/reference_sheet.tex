...
In principle it can be calculated by making slices of the perimter times the a
height dr and relating the distance of dr to the point to where the electric
field will be evaluated.
\begin{align*}
  E = \frac{\sigma}{2\epsilon_0} \left( 1 - \frac{r}{ \sqrt{r^2+R^2} } \right)
\end{align*}
Note that $r$ is the distance along the axis of the disk
